...
@interface XMNWebProgressView ()

@property (strong, nonatomic) UIView *progressBarView;

@end

@implementation XMNWebProgressView
...
- (void)setupUI {
    ...
    self.progressColor = [UIColor colorWithRed:22.f / 255.f green:126.f / 255.f blue:251.f / 255.f alpha:1.0]; // iOS7 Safari bar color
    ...
    if ([UIApplication.sharedApplication.delegate.window respondsToSelector:@selector(setTintColor:)] && UIApplication.sharedApplication.delegate.window.tintColor) {
        self.progressColor = UIApplication.sharedApplication.delegate.window.tintColor;
    }
